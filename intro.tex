...
Em primeiro momento, fazemos uma revisão de tópicos relacionados a redes neurais convolucionais, seguida por uma análise dos algoritmos de histograma de gradientes orientados e de floresta de regressão, utilizados para identificação e detecção de marcadores faciais, respectivamente.
