...
No desenvolvimento deste trabalho foi utilizada em caráter primário a linguagem de programação Python. Originalmente, o trabalho seria desenvolvido em C++ devido ao mais alto desempenho desta, porém a utilização de diversas bibliotecas com interface em Python levou à sua escolha para a implementação final do projeto.
