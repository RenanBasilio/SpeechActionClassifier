...
%Essa estrutura foi construída de tal forma que as informações relevantes ao carregador de amostras da rede neural pudessem ser obtidas todas a partir do caminho para o mesmo no sistema de arquivos.
