...
def get_model(input_shape):
    return Sequential([
        ...
        Conv3D(16, (4, 3, 3), activation='relu', name="conv3d_0"),
        MaxPooling3D(),
        Conv3D(32, (3, 3, 3), activation='relu', bias_regularizer=l1(0.01), name="conv3d_1"),
        MaxPooling3D(),
        Conv3D(64, (1, 3, 3), activation='relu', name="conv3d_2"),
